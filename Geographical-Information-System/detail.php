...
<script>
  function initialize() {
    ...
    var contentString = '<div id="content">' +
      ...
      '<img src="gambar/<?php echo $image ?>" style="max-width:auto;height:200px;margin:auto;display:block;" alt="<?php echo $nama_wisata ?>" onclick="window.location.href=\'test/test.html\'">'+
      '<div id="bodyContent">' +
      '<p><?php echo $alamat?> <br> <?php echo $lat, $long ?></p>' +
      // '<button onclick="window.location.href=\'data.php\'">Next Page</button>' +
      '</div>' +
      '</div>';
